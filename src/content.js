        ...
        <div className='flex justify-center w-full'>
            <div className='flex-col w-2/4'>
                <ReactCardFlip isFlipped={isFlipped} flipDirection="horizontal">
                    ...
                    <div onClick={handleClick} className='front relative bg-gradient-to-tr from-blue-500 to-blue-800 w-full m-auto rounded-3xl h-80'>
                    ...
                    <div onClick={handleClick} className=' back relative bg-gradient-to-tr from-teal-500 to-teal-900 w-full m-auto rounded-3xl h-80'>
                        <div className='flex justify-between mx-5'>
                            <img src={Hint} className='h-7 w-5 absolute top-5 left-5'></img>

                            <i className='pi pi-volume-up text-white absolute top-5 text-2xl right-5 '></i>
                        </div>
                        <p className=" left-2/4 text-3xl absolute text-white -translate-x-1/2 -translate-y-1/2 top-2/4">5x + 12</p>
                    </div>
                </ReactCardFlip>
